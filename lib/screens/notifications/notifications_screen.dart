    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: notification.isRead 
            ...
            : (isDark ? AppColors.darkPrimary.withValues(alpha: 0.07) : AppColors.lightPrimary.withValues(alpha: 0.05)),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: notification.isRead 
              ? (isDark ? AppColors.darkBorder.withValues(alpha: 0.5) : AppColors.lightBorder.withValues(alpha: 0.5))
              : (isDark ? AppColors.darkPrimary.withValues(alpha: 0.25) : AppColors.lightPrimary.withValues(alpha: 0.2)),
          width: 0.5,
        ),
      ),
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: GoogleFonts.inter(
                fontSize: 11,
                color: (isDark ? AppColors.darkMutedForeground : AppColors.lightMutedForeground).withValues(alpha: 0.7),
              ),
            ),
          ],
        ),
