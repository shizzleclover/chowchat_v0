...
import '../favorites/favorite_spots_screen.dart';
import '../highlights/meals_of_week_screen.dart';
import '../highlights/spot_of_week_screen.dart';
        ...
        child: Row(
          children: [
            ...
            _quickButton(
              ...
              label: 'Favorites',
              onTap: () => context.push(AppRoutes.favoriteSpots),
            ),
            const SizedBox(width: 12),
            _quickButton(
              icon: Icons.restaurant_menu_rounded,
              label: 'Meals',
              onTap: () => context.push(AppRoutes.mealsOfWeek),
            ),
            const SizedBox(width: 12),
            _quickButton(
              icon: Icons.store_mall_directory_rounded,
              label: 'Spot',
              onTap: () => context.push(AppRoutes.spotOfWeek),
            ),
          ],
        ),
      ),
