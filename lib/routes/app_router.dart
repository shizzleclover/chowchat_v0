...
import '../screens/favorites/favorite_spots_screen.dart';
import '../screens/highlights/meals_of_week_screen.dart';
import '../screens/highlights/spot_of_week_screen.dart';
...
class AppRoutes {
  ...
  static const String favoriteSpots = '/favorites';
  static const String mealsOfWeek = '/highlights/meals';
  static const String spotOfWeek = '/highlights/spot';
}
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      // Favorites
      GoRoute(
        path: AppRoutes.favoriteSpots,
        name: 'favoriteSpots',
        builder: (context, state) => const FavoriteSpotsScreen(),
      ),

      // Highlights
      GoRoute(
        path: AppRoutes.mealsOfWeek,
        name: 'mealsOfWeek',
        builder: (context, state) => const MealsOfWeekScreen(),
      ),
      GoRoute(
        path: AppRoutes.spotOfWeek,
        name: 'spotOfWeek',
        builder: (context, state) => const SpotOfWeekScreen(),
      ),
    ],
